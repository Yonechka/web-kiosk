<script setup>
  ...
  const updatingValue = () => {
    ...
    if (validate) {
      ...
      toast.error(validationTemplate[props.validation.type].message, {
        position: toast.POSITION.TOP_CENTER,
        theme: 'colored',
        icon: false
      });
...
<Teleport to=".appWrapper">
    <div v-show="isShow" class="w-full h-full absolute top-0  flex items-end z-[99]">
        ...
        <div @click="closeKeyboard" class="bg-[#C66C6C] cursor-pointer absolute z-[91] top-[1100px] left-[480px] rounded-full w-[98px] h-[98px]">
            <img src="./../../../assets/images/x.png" class="">
        </div>
        <div class="mx-auto w-[856px] lg:w-[856px] z-[100]">
        <div class="mt-[40px]">
            <input ref="input" type="text" class="w-[856px] outline-none rounded-t-[11px] border-[#858585] rounded-b-[8px] flex border-[1px] pl-8 py-[20px] text-[#000] text-[30px] font-medium"
            ...
            <div class="bg-[#D9D9D9] mt-[30px] rounded-t-[28px]">
                <div class="pb-[15px] pt-6">
                    ...
                    <div class="px-[70.55px]  mt-[25px] flex justify-between gap-[13px]">
                        ...
                        <div @click="deleteLetter" class="bg-[#fff] flex items-center justify-center  w-[106px] rounded-[10.947px] border-[1px] border-[#858585] border-b-[2.189333200454712px] shadow ring-offset-black ring-opacity-30">
