    ...
    <div class=" rounded-[35px] mt-[67px] relative">
        ...
        <div class="w-full mt-[20px]">
            ...
            <div class="flex justify-between items-center  pt-[9px]">
                <div class="font-medium text-[19px]" :class="`${colors.fontPrimaryColor}`">Jumlah Kursi</div>
                <div class="font-medium text-[19px]" :class="`${colors.fontPrimaryColor}`">{{ selectedSeats.length }} kursi</div>
            </div>
            ...
            <!-- Customer Detail -->
            <div class="font-medium text-xl pt-[20px]" :class="`text-[${colors.fontSecondaryColor300}]`">Detail Pemesanan</div>
            <div class="flex justify-between items-center mb-[10px] mt-[14px]">
                <div class="font-medium text-[19px]" :class="`${colors.fontPrimaryColor}`">Nomor Telepon</div>
