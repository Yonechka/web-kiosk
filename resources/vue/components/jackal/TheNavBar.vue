    ...
    <div class="w-[323px]  flex flex-col justify-between" :class="`bg-[${colors?.secondaryColor}]`">
        <div class="flex flex-col">
            <div class="w-[294px] self-end">
                <img src="../../assets/images/logo-blue-text.png" alt="" class="h-[130px] w-[123.36] mt-[67px] mx-auto">
            </div>
            ...
            <div class="self-end cursor-default rounded-l-[26px] w-[294px] h-[150px] flex items-center justify-center"
...
<style scoped>
  .active {
    ...
    color:v-bind('colors.fontSecondaryColor');
  }
</style>
