                    ...
                    >
                        <div v-if="isToday">
                            <div v-if="index === 0" class="h-[35px] w-[149px] bg-[#17706F] pb-[22px] mt-[10px] ml-[17px] leading-[23px] rounded-[8px]">
                                <p class=" text-[#FFFFFF] text-[20px]  py-[6px] text-center">
      ...
      <Transition :duration="350" name="nested">   
        <div v-show="isShow" class="w-full h-full absolute top-0 flex justify-end items-center">
            ...
            <div class="flex inner z-[99] h-full items-center">
                <div @click="departureTimeModal" class="bg-[#C66C6C] flex items-center justify-center z-[100] cursor-pointer absolute ml-[-140px] self-center rounded-full w-[98px] h-[98px]">
                    ...
                    <div class="grid grid-cols-3 gap-x-[20px] gap-y-[16px]  ml-[38px]">
                        ...
                        >
                            <div v-if="isToday">
                              <div
                                v-if="index === 0"
                                class="h-[35px] w-[149px] pb-[22px] bg-[#17706F] mt-[10px] ml-[17px] leading-[23px] rounded-[8px]"
                              >
                                  <div class="text-[#FFFFFF] text-[20px]  py-[6px] text-center">
                                    {{ $t('schedule.times.leaveSoon') }}
                                  </div>
                              </div>
                            </div>
