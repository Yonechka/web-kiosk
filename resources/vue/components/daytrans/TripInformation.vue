<script setup>
  ...
  import { formattingDate, formattingNumber, dmyStringToDate } from '../../utils';
    ...
    <div class=" rounded-[35px] mt-[67px] relative">
          ...
          <div class="flex">
            ...
            <div>
                ...
                <div class="flex pt-[30px] items-center">
                    ...
                    >
                      {{ $d(dmyStringToDate(bookingInfo?.departure_date), 'long') }}
                    </div>
        ...
        <div class="w-full mt-[20px]">
            ...
            <div class="flex justify-between items-center  pt-[5px]">
                ...
                <div class="font-bold text-[29px]" :class="`${colors.fontPrimaryColor}`">Rp. {{ formattingNumber(totalTicketPriceNewAsmat) }} </div>
            </div>
            <div v-if="features.isInsurance" class="flex flex-col items-end text-[#10B94E] text-[20px] font-semibold pt-[5px]">
              ...
              <div v-if="scheduleStore.appliedVoucher" class="flex items-center text-[#10B94E] text-[20px] font-semibold mt-2">
                ...
                {{ $t('tripCard.deduction') }} (-{{ formattingNumber(scheduleStore.voucherData.deduction_nominal)  }})
              </div>
