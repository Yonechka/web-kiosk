<script setup>
  ...
  /* Print Ticket */
  const { isPrinting, printTicket, rePrintTicket } = usePrintTicket(toast, t, d);
                    ...
                    <template #detail>
                        ...
                        <div @scroll="scrollPassengersWrapper" ref="passengersWrapper" class="max-h-[242px] overflow-auto w-full relative">
                            ...
                            >
                                ...
                                <div v-if="passenger.is_with_infant == '1'" class="flex">
                                    <div
                                      class="font-medium w-[111px] text-[19.46px] mb-[3px]"
                                      :class="`text-[${colors.fontSecondaryColor300}]`"
                                    >
                                    ...
                                    <div class="font-semibold text-[19.46px]">
                                      : <span v-if="passenger.infant_name.length > 6">
                                          {{ passenger.infant_name.slice(0, 6) + "..." }}
                                        </span>
                                        <span v-else>
                                          {{ passenger.infant_name }}
                                        </span>
                                        <!-- ({{ calculateAge(passenger.infant.birthDate) }} Tahun) -->
                                    </div>
                                </div>
                                <div class="flex">
                                    <div
