<script setup>
  ...
  /* EDC */
  const { isEdc, showSpinnerEdc, closeEdcModal, edcModal } = useEDC(router, t, true) //isNewAsmat
...
<template>
    ...
    <div v-if="!isShow" class="mt-[40px] rounded-[35px] w-full mb-[224.71px]" :class="`bg-[${colors.secondaryColor}]`">
        ...
        <div class="flex justify-between items-center pl-[34.5px] pb-[0px] pt-[32px]">
            <div class="font-medium text-2xl" :class="`text-[${colors.fontSecondaryColor300}]`">
        ...
        <div class="mx-auto flex justify-center">
            <div
              ...
              :class="`text-[${colors.fontPrimaryColor}]`"
              v-html="$t('payment.qrisScan')"
            >
            </div>
        </div>
        
        <img :src="bookingInfo.payment_status.client_data.qr_url" class="w-[150px] mb-4 mx-auto">
        <div class="w-[544px] mx-auto rounded-[11px] text-[24px] text-[#672B2B] py-[15px] flex justify-center items-center bg-[#FFEAEA]">
          ...
          <span class="font-bold text-[#ED1B24] mr-[6px]">
            {{ minutesFormat }}:{{ secondFormat }}
          </span> {{ $t('payment.remainingTime') }}
        </div>
        ...
        <div class="flex pl-[51px] pr-[51px] pt-[30px] pb-[25px] items-center justify-center">
            <div
              @click="howToPayModal"
              class="py-[20px] w-[47%] rounded-[26px] flex items-center justify-center bg-[#00990F] text-white"
            >
            ...
            <div
              ...
              class="py-[20px] w-[50%] rounded-[26px] flex items-center justify-center ml-[30px] bg-[#00990F] text-white"
            >
                <div class="font-bold text-xl">
        ...
        <div class="flex pt-[25px] pb-[33px] mx-auto ">
            <img src="../../../assets/images/payment/bank.png" class="h-[69.52px] w-[597px] mx-auto">
        </div>
        <template v-if="features.edc.length > 0 && features.edc.includes(departureCodeLS)">
          <div
          ...
          <div  class="flex justify-center px-[23px] pb-[33px]">
              ...
              >
                  ...
                  <div class="font-bold text-4xl pl-[30px]" :class="`text-[${colors.secondaryColor}]`">EDC BCA</div>
    ...
    <Teleport to=".appWrapper">
      <div
        ...
        :class="`bg-[${colors.primaryColor}]`"
      >
        <NetworkIndicator class="absolute top-[20px] right-[20px] z-[99]" />
        <OverlaySpinner bg="bg-[#00000060]" v-if="showSpinnerEdc"/>
        <div class="flex  mb-[25px] justify-between">
            <!-- navbar menu -->
            <div class="pt-[126px] ">
                <img :src="images.logoSecondary" alt="" class="w-[239px]">
            </div>
