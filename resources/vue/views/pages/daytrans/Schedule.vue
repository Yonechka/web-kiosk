<script setup>
  ...
  import DeparturePool from '../../../components/daytrans/schedule/DeparturePool.vue';
  import DestinationPool from '../../../components/daytrans/schedule/DestinationPool.vue';
  import DepartureDate from '../../../components/daytrans/schedule/DepartureDate.vue';
  import DepartureTime from '../../../components/daytrans/schedule/DepartureTime.vue';
  import SeatsLayout from '../../../components/daytrans/schedule/SeatsLayout.vue';
...
<template>
    <ErrorState :bg="`bg-[${colors.primaryColor}]`" @retryOnClick="fetchInitialData" v-show="isError"></ErrorState>
