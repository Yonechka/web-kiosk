...
const routes = [
  ...
  },
  {
    path: '/btm/schedule',
    name: 'schedule',
    component: Features.BTM.useV2 ? ScheduleV2 : Schedule,
    beforeEnter: (to, from) => {
  ...
  {
    path: '/btm/reservation',
    name: 'reservation',
    component: Features.BTM.useV2 ? ReservationV2 : Reservation,
    beforeEnter: (to, from) => {
      if (from.name === 'completed') {
  ...
  },
  {
    path: '/btm/payment',
    name: 'payment',
    component: Features.BTM.useV2 ? PaymentV2 : Payment,
    beforeEnter: (to, from) => {
  ...
  },
  {
    path: '/btm/completed',
    name: 'completed',
    component: Features.BTM.useV2 ? CompletedV2 : Completed,
    beforeEnter: (to, from) => {
  ...
  },
  {
    path: '/btm/thanks',
    name: 'thanks',
    component: Features.BTM.useV2 ? ThanksV2 : Thanks,
  },
  {
    path: '/:pathMatch(.*)',
    name: 'NotFound',
