...
exports.formattingDate = exports.basicAuth = exports.remodelFeatures = exports.remodel = void 0;
const member_1 = __importDefault(require("./remodel/member"));
exports.remodel = {
    asmat: {
        params: {
            departure(payload) {
            ...
            voucherCheck({ departure_date, product_id, phone_no, code }) {
                return {
        ...
        response: {
            ...
            departure(payload) {
                const remodeled = payload.whitelabel.result.map(({ kode_cabang: pool_code, nama_cabang: pool_name, alamat_cabang: pool_address, alamat_cabang_lengkap: pool_full_address, kota: city, ...rest }) => ({
                    pool_code,
                    pool_name,
                    pool_address,
                    pool_full_address,
            ...
            destination(payload) {
                const remodeled = payload.whitelabel.result.map(({ id_jurusan: destination_id, kode_jurusan: destination_code, cabang_asal: departure_pool, kota_asal: departure_city, cabang_tujuan: destination_pool, kota_tujuan: destination_city, harga_tiket: ticket_price, harga_tiket_min: min_ticket_price, harga_tiket_max: max_ticket_price, img_kota_asal: departure_city_image, img_kota_tujuan: destination_city_image, ...rest }) => ({
                    destination_id,
                    destination_code,
                    departure_pool,
                    departure_city,
            ...
            schedule(payload) {
                if (!payload.whitelabel.results.jadwal)
                    return [];
                const remodeled = payload.whitelabel.results.jadwal.map(({ kode: code, layanan: service, list_transit: list_transit, jam_berangkat: departure_time, layout_kursi: layout_seat, jumlah_kursi: seat_total, jumlah_booking: booking_total, sisa_kursi: available_seat, harga_tiket: ticket_price, ...rest }) => ({
                    code,
                    service,
                    list_transit,
                    departure_time,
            ...
            seat(payload) {
                const { baris: row, kolom: col, kapasitas: capacity, isjemput: isPickup, jemputminfree: pickupMinFree, jemputbiayadalamarea: pickupFeeinsideArea, jemputmindalamarea: pickupMinInsideArea, jemputbiayaluararea: pickupFeeOutsideArea, jemputminluararea: pickupMinOutsideArea, isantar: isDropoff, antarminfree: dropoffMinFree, antarbiayadalamarea: dropoffFeeInsideArea, antarmindalamarea: dropoffMinInsideArea, antarbiayaluararea: dropoffFeeOutsideArea, antarminluararea: dropoffMinOutsideArea, peta_layout: seats_layout, no_manifest: manifest_no, kode_kendaraan: vehicle_code, no_polisi: license_plate, kode_driver: driver_code, nama_driver: driver_name, } = payload.whitelabel.result;
                const remodel = {
                    row,
                    col,
                    capacity,
                ...
                const seatsLayoutRemodel = remodel.seats_layout.map(({ notiket: ticket_no, namapenumpang: passanger_name, tglberangkat: departure_date, kodejadwal: schedule_code, kodebooking: booking_code, iscetaktiket: isPrintTicket, jenispembayaran: payment_method, ...rest }) => ({
                    ticket_no,
                    passanger_name,
                    departure_date,
                    schedule_code,
            ...
            voucherCheck(payload) {
                if (payload.whitelabel.status !== 'OK')
                    return payload;
                const { keterangan, nominal, total, ishargatetap, namavoucher } = payload.whitelabel.result;
                return {
            ...
            bookingDetail(payload) {
                ...
                const passengersRemodel = remodeled.passengers.map(({ notiket: ticket_no, nama_penumpang: passenger_name, is_bayi: is_infant, umur_bayi: infant_age, nomor_kursi: seat_no, kode_jadwal: schedule_code, asal: departure, tujuan: destination, tgl_berangkat: destination_date, tgl_berangkat_formatted: destination_date_formatted, min_tgl_mutasi: mutation_date_min, min_tgl_mutasi_formatted: mutation_date_min_formatted, max_tgl_mutasi: mutation_date_max, max_tgl_mutasi_formatted: mutation_date_max_formatted, jam_berangkat: departure_time, is_mutasi: is_mutation, status_mutasi: mutation_status, ...rest }) => ({
                    ticket_no,
                    passenger_name,
                    is_infant,
                    infant_age,
            ...
            detailBoarding(payload) {
                ...
                const { kode_jadwal, kode_booking, jam_berangkat, no_tiket, no_kursi, harga_tiket, diskon, total, otp_used, zona, alamat_antar, penumpang, pemesanan, cso_cetak, asal, tujuan, tgl_berangkat, kode_kendaraan, no_polisi, nama_driver, } = payload.whitelabel.result;
                const remodeled = {
                    message: payload.whitelabel.pesan,
            ...
            printInfo(payload) {
                ...
                const remodeled = payload.whitelabel.result.map(({ perusahaan_alamat: company_address, perusahaan_nama: company_name, perusahaan_telp: company_phone_no, perusahaan_website: company_website, catatan_tiket: ticket_note, qr_code2: qr_code, no_tiket: ticket_no, tgl_berangkat: departure_date, jam_berangkat: departure_time, kode_jadwal: schedule_code, nama_penumpang: passenger_name, is_with_infant: is_with_infant, nama_infant: infant_name, nomor_kursi: seat_no, harga_tiket: ticket_price, diskon_promo: promo_discount, diskon_voucher: voucher_discount, total_bayar: total_payment, nama_promo: promo_name, kode_voucher: voucher_code, waktu_transaksi: transaction_time, cso: cso, jenis_pembayaran: payment_type, asal: departure, tujuan: destination, nama_cabang_tujuan: destination_pool_name, via: via }) => ({
                    company_name,
                    company_address,
                    company_phone_no,
                    company_website,
    ...
    asmatNew: {
        params: {
            ...
            priceTotal({ departure_date, product_id, departure_outlet, destination_outlet, seats, is_insurance, voucher_code, departure_date_return, product_id_return, departure_outlet_return, destination_outlet_return, seats_return, }) {
                const params = {
            ...
            voucherCheck({ departure_date, departure_time, product_id, departure_outlet, destination_outlet, seats, phone_no, code, isRoundTrip = 0 }) {
                return {
                    tglberangkat: departure_date,
            ...
            ...member_1.default.newAsmat.params
        },
        response: {
            status(payload) {
            ...
            departure(payload) {
                const remodeled = payload.tiketux.result.outlet.map(({ id: pool_code, nama: pool_name, alamat: pool_address, alamat: pool_full_address, kota: city, ...rest }) => ({
                    pool_code,
                    pool_name,
                    pool_address,
                    pool_full_address,
            ...
            destination(payload) {
                const remodeled = payload.tiketux.result.outlet.map(({ id: destination_id, id: destination_code, nama: destination_pool, kota: destination_city, min_tarif: ticket_price, min_tarif: min_ticket_price, max_tarif: max_ticket_price, img: destination_city_image, ...rest }) => ({
                    destination_id,
                    destination_code,
                    destination_pool,
                    destination_city,
            ...
            schedule(payload) {
                if (!payload.tiketux.result.produk)
                    return [];
                const remodeled = payload.tiketux.result.produk.map(({ id_produk: code, nama_layanan: service, list_transit: list_transit, jam_berangkat: departure_time, jumlah_kursi: seat_total, kursi_terisi: booking_total, sisa_kursi: available_seat, tarif: ticket_price, range_tarif: ticket_price_range, range_tarif_disc: ticket_price_disc_range, tgl_berangkat: departure_date, ...rest }) => ({
                    code,
                    service,
                    list_transit,
                    departure_time,
            ...
            seat(payload) {
                ...
                const { totalpenumpang, totalkuota, baris, kolom, kapasitas, tipe_kendaraan, petalayout_pp, totalpenumpang_pp, totalkuota_pp, baris_pp, kolom_pp, kapasitas_pp } = payload.tiketux.result;
                const remodeled = {
                ...
                const seatsLayoutRemodel = seatsLayout.map(({ notiket: ticket_no, tglberangkat: departure_date, nama: passanger_name, idproduk: schedule_code, kodebooking: booking_code, iscetaktiket: isPrintTicket, jenispembayaran: payment_method, kodepromo: promo_code, namapromo: promo_name, hargatiket: price, totalbayar: total_price, ...rest }) => ({
                    ticket_no,
                    departure_date,
                    passanger_name,
                    schedule_code,
                ...
                let remodeledReturn = {};
                let seatsLayoutReturn = [];
                let seatsLayoutReturnRemodel = [];
                if (petalayout_pp) {
                    remodeledReturn = {
                    ...
                    seatsLayoutReturnRemodel = seatsLayoutReturn.map(({ notiket: ticket_no, tglberangkat: departure_date, nama: passanger_name, idproduk: schedule_code, kodebooking: booking_code, iscetaktiket: isPrintTicket, jenispembayaran: payment_method, kodepromo: promo_code, namapromo: promo_name, hargatiket: price, totalbayar: total_price, ...rest }) => ({
                        ticket_no,
                        departure_date,
                        passanger_name,
                        schedule_code,
            ...
            voucherCheck(payload) {
                if (payload.tiketux.status !== 'OK')
                    return payload;
                const { kode_potongan, jenis_potongan, nilai_potongan, total_bayar, tipe_potongan, IsPromo, IsGabungPromo, PrioritasDiskon } = payload.tiketux.result;
                return {
            ...
            priceTotal(payload) {
                ...
                const remodeledSeats = list_kursi.map(({ nomor_kursi: seats_no, harga_tiket: ticket_price, biaya_addon_asuransi: insurance_rates, ...rest }) => ({
                    seats_no,
                    ticket_price,
                    insurance_rates,
                    ...rest
            ...
            bookingDetail(payload) {
                if (payload.tiketux.status == 'ERROR')
                    return payload;
                const data = payload.tiketux.result;
                const { nama_pemesan, kota_asal_pergi, kota_tujuan_pergi, tgl_berangkat_pergi, jam_berangkat_pergi, total_bayar, telp_pemesan, total_discount } = data;
                ...
                const passengersRemodel = remodeled.passengers.map(({ no_tiket: ticket_no, nama: passenger_name, no_kursi: seat_no, qr_content: qr_code, ...rest }) => ({
                    ticket_no,
                    passenger_name,
                    seat_no,
                    qr_code,
                ...
                if (data?.detail_tiket_pp) {
                    ...
                    const passengersReturnRemodel = passengersReturn.map(({ no_tiket: ticket_no, nama: passenger_name, no_kursi: seat_no, qr_content: qr_code, ...rest }) => ({
                        ticket_no,
                        passenger_name,
                        seat_no,
                        qr_code,
            ...
            printInfo(payload) {
                ...
                const data = payload.tiketux.result;
                const remodeled = data.tiket.map(({ nomor_tiket: qr_code, nomor_tiket: ticket_no, tgl_berangkat: departure_date, jam_berangkat: departure_time, kode_jadwal: schedule_code, nama_penumpang: passenger_name, nomor_kursi: seat_no, harga: ticket_price, discount_promo: promo_discount, discount_voucher: voucher_discount, harga_total: total_payment, kode_promo: promo_name, kode_voucher: voucher_code, waktu_pesan: transaction_time, jenis_pembayaran: payment_type, outlet_asal: departure_pool_name, outlet_tujuan: destination_pool_name, kota_asal: departure, kota_tujuan: destination, via: via }) => ({
                    qr_code,
                    ticket_no,
                    departure_date,
                    departure_time,
            ...
            detailBoarding(payload) {
                ...
                const { kode_jadwal, kode_booking, jam_berangkat, nomor_tiket, nomor_kursi, harga_tiket, discount, total_bayar, is_boarding, nama_penumpang, cso_cetak_tiket, outlet_pickup, outlet_dropoff, tgl_berangkat, } = payload.tiketux.result.tiket;
                const remodeled = {
                    message: payload.tiketux.pesan,
                    shcedule_code: kode_jadwal,
                    booking_code: kode_booking,
            ...
            ...member_1.default.newAsmat.response
        }
    }
};
const remodelFeatures = (features) => {
    const remodeled = [
        {
            title: 'Reservasi',
...
exports.remodelFeatures = remodelFeatures;
const basicAuth = (headers) => {
...
exports.formattingDate = formattingDate;
